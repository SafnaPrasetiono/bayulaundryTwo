                                ...
                                <td class="gap-1">
                                    <div class="dropstart">
                                        ...
                                        <div class="dropdown-menu position-fixed border-0 shadow" style="width: 200px">
                                            <a class="dropdown-item link-black" href="{{ route('admin.account.detail', ['id' => $item->admin_id, 'slug' => $item->slug]) }}">
                                                <i class="fas fa-eye fa-sm me-3"></i> Detail
                                            </a>
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.account.update', ['id' => $item->admin_id, 'slug' => $item->slug]) }}">
