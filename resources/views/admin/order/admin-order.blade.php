<div>
    <div class="container-fluid">
        ...
        <div class="d-block p-3 mb-2">
            <h2 class="text-them fw-bold mb-0">Order Laundry</h2>
        ...
        <div class="d-block bg-white rounded p-3">
            <div class="form-tables mb-3">
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.product.laundry.create') }}" class="btn btn-outline-success">
                            ...
                            <tr>
                                <th class="text-wrap">
                                    <input type="checkbox" wire:model="selected" wire:change="clickSelectedOne"
                                        class="form-check-input" value="{{ $item->order_id }}">
                                </th>
                                <th class="text-them">
                                    {{ $item->invoice }}
                                </th>
                                    ...
                                    <div class="dropstart">
                                        ...
                                        <div class="dropdown-menu position-fixed border-0 shadow" style="width: 200px">
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.order.detail', ['id' => $item->order_id, 'inv' => $item->invoice]) }}">
                                                <i class="fas fa-eye fa-sm me-3"></i> Detail
                                            </a>
                                            {{-- <a class="dropdown-item link-black"
                                                href="{{ route('admin.product.laundry.update', ['id' => $item->order_id, 'slug' => $item->slug]) }}">
                                            ...
                                            <button class="dropdown-item"
                                                wire:click="DeleteAction({{ $item->order_id }})">
