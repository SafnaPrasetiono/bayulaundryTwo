<div>
    <div class="container-fluid">
        ...
        <div class="d-block p-3 mb-2">
            <h2 class="text-them fw-bold mb-0">Product Laundry</h2>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-them">Product_name</th>
                                    ...
                                    <div class="dropstart">
                                        ...
                                        <div class="dropdown-menu position-fixed border-0 shadow" style="width: 200px">
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.product.laundry.detail', ['id' => $item->product_id, 'slug' => $item->slug]) }}">
                                                <i class="fas fa-eye fa-sm me-3"></i> Detail
                                            </a>
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.product.laundry.update', ['id' => $item->product_id, 'slug' => $item->slug]) }}">
                                            ...
                                            <button class="dropdown-item"
                                                wire:click="DeleteAction({{ $item->product_id }})">
