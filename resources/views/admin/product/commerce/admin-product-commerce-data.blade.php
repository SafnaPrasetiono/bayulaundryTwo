<div>
    <div class="container-fluid">
        ...
        <div class="d-block p-3 mb-2">
            <h2 class="text-them fw-bold mb-0">Commerce</h2>
        ...
        <div class="d-block bg-white rounded p-3">
            <div class="form-tables mb-3">
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.product.commerce.create') }}" class="btn btn-outline-success">
                                    ...
                                    <div class="dropstart">
                                        ...
                                        <div class="dropdown-menu position-fixed border-0 shadow" style="width: 200px">
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.product.commerce.detail', ['id' => $item->product_id, 'slug' => $item->slug]) }}">
                                                <i class="fas fa-eye fa-sm me-3"></i> Detail
                                            </a>
                                            <a class="dropdown-item link-black"
                                                href="{{ route('admin.product.commerce.update', ['id' => $item->product_id, 'slug' => $item->slug]) }}">
